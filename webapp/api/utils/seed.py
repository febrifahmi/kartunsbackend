    ...
    try:
        ...
        if artikelexist == 0:
            seeddata = {
                ...
                "articletext": "Tahun 2022 telah menjadi tahun yang luar biasa bagi para arsitek alumni Universitas Sebelas Maret (UNS). Berbagai sayembara arsitektur telah diadakan di seluruh Indonesia, dan para arsitek alumni UNS tersebut berhasil memenangkan banyak di antaranya. Ini merupakan prestasi yang sangat luar biasa dan tentunya menjadi suatu kebanggaan bagi para arsitek alumni UNS tersebut. Namun, tidak hanya itu saja, prestasi tersebut juga merupakan inspirasi bagi para arsitek muda lainnya yang sedang meniti karier di dunia arsitektur. Para arsitek alumni UNS tersebut telah menunjukkan bahwa dengan kerja keras dan kemampuan yang dimiliki, seseorang dapat mencapai kesuksesan di bidang yang dipilihnya. Mereka juga telah memberikan bukti bahwa Universitas Sebelas Maret merupakan salah satu perguruan tinggi terbaik di Indonesia yang dapat menghasilkan arsitek-arsitek handal dan berprestasi. Keberhasilan para arsitek alumni UNS tersebut juga merupakan bukti bahwa arsitektur Indonesia telah mampu bersaing dengan arsitektur dunia. Mereka telah membuktikan bahwa arsitektur Indonesia tidak hanya memiliki nilai estetika yang tinggi, tetapi juga mampu memberikan solusi yang inovatif dan sesuai dengan kebutuhan masyarakat. Para arsitek alumni UNS tersebut juga telah memberikan sumbangsih yang besar bagi perkembangan arsitektur Indonesia. Mereka telah menciptakan berbagai bangunan yang memiliki nilai estetika tinggi, sesuai dengan kebutuhan masyarakat, serta mampu menjawab tantangan lingkungan dan iklim. Dengan prestasi yang telah dicapai oleh para arsitek alumni UNS tersebut, kita sebagai masyarakat Indonesia dapat terinspirasi untuk terus belajar dan berusaha mencapai kesuksesan di bidang yang dipilih. Kita juga dapat bangga dengan prestasi yang telah dicapai oleh para arsitek alumni UNS tersebut, dan terus memberikan dukungan kepada mereka agar dapat terus berkarya dan memberikan sumbangsih yang lebih besar bagi perkembangan arsitektur Indonesia.",
            }
            artikel_schema = (
                ArticleSchema()
            )
