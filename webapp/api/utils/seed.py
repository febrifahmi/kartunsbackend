...
def seedArtikelData():
    ...
    try:
        ...
        for item in existingartikel:
            if (
                item["articletitle"]
                == "Munas Keluarga Alumni Arsitektur UNS KartUNS Tahun 2022 Berlangsung Sukses"
            ):
                artikelexist = 1
        if artikelexist == 0:
            seeddata = {
        ...
        for item in existingartikel:
            if (
                item["articletitle"]
                == "Arsitek Alumni UNS Memenangkan Berbagai Sayembara Arsitektur Tahun 2022"
            ):
                artikelexist = 1
        if artikelexist == 0:
            seeddata = {
